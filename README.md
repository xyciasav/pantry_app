...
The default Docker image is named `shelf-life:1.9.3`, and the same version appears in the website header, footer, and `/health` response.

Portainer stack variables can override these values:

- `PANTRY_VERSION=1.9.3` controls the Docker tag and displayed website version.
